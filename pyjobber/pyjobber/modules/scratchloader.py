        ...
        for r, d, f in os.walk(self.path):
            ...
            for file in f:
                ...
                if '.csv' in file:
                    ...
                    #if list(self.db.find_one(dc_temp))[0]['filename'] == dc_temp['filename']:
                    #    print("pull")
                    #    #k_id = list(self.db.find_one(dc_temp_old))[0]['_id']
                    #    k_id = list(self.db.find_one(dc_temp))
                    #    #print(k_id)
                    #    for ik in k_id:
                    #        print(ik['_id'])
                    #        self.db.delete_one(ik)

                        #self.db.find_one_and_update( k_id, dc_temp)
                    #continue
