...
def main(*args):
    ...
    if args.module == "default" or args.module not in CallCollector :
        ...
        for i_module in CallCollector:
            logging.warning("-> ", i_module)
        exit()

    #call the mongodb database:
    #db = MongoDBapi()
...
def ping():
    ...
    db.connect()
    db_answer = db.verify()
    print("Quick & Dirty ping test (not connection): ", db_answer)
